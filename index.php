        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Transaksi Jual</h6>
...
<?php if ($page == 'dashboard'): ?>
    <div class="my-2"></div>
    <a href="index.php?page=barang" class="btn btn-primary btn-icon-split btn-lg mb-4 p-4">
        <span class="icon text-white-50">
            <i class="fas fa-flag"></i>
        </span>
        <span class="text">Data Barang</span>
    </a>
    <a href="#" class="btn btn-success btn-icon-split btn-lg mb-4 p-4">
        <span class="icon text-white-50">
            <i class="fas fa-flag"></i>
        </span>
        <span class="text">Stok Barang</span>
    </a>
    <a href="#" class="btn btn-info btn-icon-split btn-lg mb-4 p-4">
        <span class="icon text-white-50">
            <i class="fas fa-flag"></i>
        </span>
        <span class="text">Tabel Laporan</span>
    </a>
    <a href="#" class="btn btn-warning btn-icon-split btn-lg mb-4 p-4 ">
        <span class="icon text-white-50">
            <i class="fas fa-flag"></i>
        </span>
