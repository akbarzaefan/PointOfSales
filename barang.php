    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
         <input type="text" name="nama_produk" id="" class="form-control mt-2" placeholder="Nama Produk:">
         <input type="num" name="harga" id="" class="form-control mt-2" placeholder="Harga:">
         <input type="num" name="stok" id="" class="form-control mt-2" placeholder="Stok Awal:">
